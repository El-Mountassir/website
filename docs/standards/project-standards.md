...
Subject: Semantic Versioning, Dublin Core Metadata, Changelog Standards

Description: The central reference for our team's versioning logic, resource description, and history tracking standards.
...
Identifier: kb/sources/knowledge/project/methodology/project-standards.md
...
> **Work Management Protocols** have been moved to `management/work/README.md` for consistency with `missions/` and `time/`.
>
> See: [Work Management Protocols](management/work/README.md)

...
- [ ] Lire `.claude/rules/platform-operations.md`
...
### 2. VERIFY — Vérifier contre state/

```
Consulter :
- state/current/rooms.md → mapping chambre
- state/current/reservations.md → conflits potentiels
```
...
2. Mettre à jour state/current/reservations.md
3. Log dans state/execution/YYYY-MM-DD/
```

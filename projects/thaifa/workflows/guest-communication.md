...
|------|-------------|--------|
| Message WhatsApp | `communication/whatsapp/YYYY-MM-DD-{sujet}.txt` | Texte brut prêt à copier |
| Email | `communication/email/YYYY-MM-DD-{sujet}.txt` | Texte brut |
| Rapport client | `state/execution/YYYY-MM-DD/deliverables/` | PDF |

...
| Tâche                                 | Status               |
| ------------------------------------- | -------------------- |
| Fusionner CLAUDE.md (454→~120 lignes) | 🟡 Pending           |
...
| Tâche                      | Status      |
| -------------------------- | ----------- |
| Contact HWS établi (Ikram) | ✅ Done     |
| Demande API en cours       | ⏳ Waiting  |
...
| --------------- | -------------- | --------------- |
| Booking.com     | ✅ Actif       | Via HotelRunner |
| Expedia         | 🔴 À connecter |                 |
| Airbnb          | 🔴 À connecter |                 |
| +17 autres OTAs | 🔴 À évaluer   | Via HotelRunner |
...
_ROADMAP v0.0.1-alpha.0 — Document vivant, mis à jour au fil de l'exécution_

...
> **Priority:** HIGH
> **Next:** RDV découverte — Lundi 22 décembre 2025, 10h
> **Created:** 2025-12-19
...
|----------|--------|------|
| **Chambres** | 12 | 9 types HotelRunner |
| **Note Booking** | 9.3/10 | Excellente réputation |
...
| Catégorie     | Détails                                            |
| ------------- | -------------------------------------------------- |
| **Détente**   | Piscine extérieure (débordement), jardin, solarium |
| **Bien-être** | Spa/Hammam, massages                               |
| **Resto**     | Restaurant sur place, petit-déjeuner inclus        |
| **Chambres**  | Climatisation, SDB privative, Wi-Fi, terrasse      |
| **Services**  | Parking gratuit, navette aéroport (supplément)     |
...
| **Points forts**    | Calme, jardins, piscine, accueil |
| **Point vigilance** | Excentré (20-30 min du centre)   |
...
*Base: 12 chambres × 365 jours × prix moyen ~200€*
...
| Dossier | Contenu |
|---------|---------|
| `communication/whatsapp/` | Messages prêts à envoyer |
| `projects/2025-12_booking-hotelrunner/` | Mission active |
| `projects/jisr-mokawala/` | Investigation portail direct |

### 12.2 État Opérationnel (SSOT)

| Fichier | Contenu |
|---------|---------|
| `state/current/rooms.md` | Chambres, pricing, mapping HotelRunner |
| `state/current/reservations.md` | 11 réservations confirmées |
| `state/current/promotions.md` | 5 promotions actives |
| `state/current/blockers.md` | Décisions en attente |
...
_Pipeline: `.claude/output/2025/Q4/reports/profile-reorganization/`_
